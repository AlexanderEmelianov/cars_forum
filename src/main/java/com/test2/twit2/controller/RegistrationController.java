...
import com.test2.twit2.domain.dto.CaptchaResposeDto;
import com.test2.twit2.service.UserService;
...
public class RegistrationController {
    ...
    public String addUser(@RequestParam("password2")String passwordConfirm, @RequestParam("g-recaptcha-response")String captchaResponse, @Valid User user, BindingResult bindingResult, Model model){
        ...
        CaptchaResposeDto respose = restTemplate.postForObject(url, Collections.emptyList(), CaptchaResposeDto.class);
        ...
        if (isConfirmEmpty || bindingResult.hasErrors() || !respose.isSuccess()){
